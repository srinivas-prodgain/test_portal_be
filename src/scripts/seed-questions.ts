...
const questions_data = [
  {
    question:
      'Explain the concept of closures in JavaScript and provide a practical use case where closures are beneficial.'
  },
  {
    question:
  ...
  {
    question:
      'Describe the RESTful API principles and explain what makes an API truly RESTful.'
  },
  {
    question:
      'What is the purpose of middleware in Express.js? Provide an example of a custom middleware function.'
  },
  {
    question:
      'Explain the concept of promises and async/await in JavaScript. How do they improve asynchronous code handling?'
  },
  {
    question:
      'What are the key differences between TypeScript and JavaScript? What are the main benefits of using TypeScript?'
  },
  {
    question:
      'Describe the SOLID principles in software engineering and explain how they contribute to better code design.'
  }
]
